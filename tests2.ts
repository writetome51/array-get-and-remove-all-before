import { getAndRemoveAllAfterLast } from './getAndRemoveAllAfterLast';
...
removed = getAndRemoveAllAfterLast(5, arr);
...
try{
	getAndRemoveAllAfterLast('', 'hello everybody!!!');
}
catch (e) {
	errorTriggered = true;
}
